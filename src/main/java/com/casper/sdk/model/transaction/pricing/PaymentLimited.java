...
public class PaymentLimited implements PricingMode {
    ...
    public void serialize(final SerializerBuffer ser, final Target target) throws ValueSerializationException, NoSuchTypeException {
        new CalltableSerializationEnvelopeBuilder()
                ...
                .addField(PAYMENT_LIMITED_PAYMENT_AMOUNT_INDEX, /* U64 */ new CLValueU64(paymentAmount.longValue()))
                .addField(PAYMENT_LIMITED_GAS_PRICE_TOLERANCE_INDEX, /* U8 */ new CLValueU8((byte) gasPriceTolerance))
                .addField(PAYMENT_LIMITED_STANDARD_PAYMENT_INDEX, /* bool */ new CLValueBool(standardPayment))
