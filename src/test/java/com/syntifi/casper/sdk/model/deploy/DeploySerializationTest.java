...
public class DeploySerializationTest extends AbstractJsonTests {
    ...
    @Test
    void deploySerialization() throws JsonMappingException, JsonProcessingException, IOException, CLValueEncodeException, DynamicInstanceException, NoSuchTypeException {
        ...
        assertEquals(digest.getDigest(), deployBytes);
    }
