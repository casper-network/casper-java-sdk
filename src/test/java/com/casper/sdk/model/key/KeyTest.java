...
class KeyTest {
    ...
    void contractPackageKeyFromKeyString() throws Exception {
        ...
        assertThat(key.getTag(), is(KeyTag.HASH));
        assertThat(key.getKey(), is(Hex.decode("0909090909090909090909090909090909090909090909090909090909090909")));
        assertThat(toJson(key), is("hash-0909090909090909090909090909090909090909090909090909090909090909"));
    ...
    void blockTimeKeyFromKeyString() throws Exception {
        ...
        assertThat(toJson(key), is("block-time-0909090909090909090909090909090909090909090909090909090909090909"));
    ...
    private String toJson(final Key key) throws JsonProcessingException {
        return new ObjectMapper().writeValueAsString(key).replace("\"", "");
    }
}
