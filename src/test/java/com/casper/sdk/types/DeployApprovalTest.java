...
class DeployApprovalTest {
    ...
    void setUp() {
        ...
        deployApproval = new DeployApproval(
                new CLPublicKey("12345678901234567890123456789012".getBytes(), Algorithm.ED25519),
    ...
    @Test
    void getSigner() {
        assertThat(deployApproval.getSigner(), is(notNullValue(CLPublicKey.class)));
    ...
    void getSignature() {
        ...
        assertThat(deployApproval.getSignature().getAlgorithm(), is(Algorithm.ED25519));
    }
}
