...
import com.casper.sdk.model.transaction.entrypoint.UndelegateEntryPoint;
...
public class HowToUnDelegate extends HowToMethods {
    ...
    void unDelegate()
        ...
        final TransactionV1Payload payload = TransactionV1Payload.builder()
            ...
            .fields(Fields.builder()
                ...
                .target(new Native())
                .entryPoint(new UndelegateEntryPoint()).build()
            )
            .build();
     ...
     *
     ...
     {
     "hash": "f0a043c88532994c1868189658ecdfcb73195edc360761ddfbf920ba998f4d16",
     "payload": {
     "initiator_addr": {
     "PublicKey": "013f69f01439509c0fd113176bcaec9170d18b70fb2bbbdcc9b28803f8bbcc429c"
     },
     "timestamp": "2025-10-05T10:14:07.659Z",
     "ttl": "30m",
     "pricing_mode": {
     "PaymentLimited": {
     ...
     "delegator",
     {
     "bytes": "013f69f01439509c0fd113176bcaec9170d18b70fb2bbbdcc9b28803f8bbcc429c",
     "cl_type": "PublicKey"
     }
     ],
     [
