...
public class HowToWithdrawBid extends HowToMethods{
    ...
    void withdrawBid()
        ...
        final PublicKey validator = PublicKey.fromTaggedHexString("013f69f01439509c0fd113176bcaec9170d18b70fb2bbbdcc9b28803f8bbcc429c");
        ...
        final List<NamedArg<?>> args = Arrays.asList(
            new NamedArg<>("public_key", new CLValuePublicKey(PublicKey.fromAbstractPublicKey(validator.getPubKey()))),
        ...
        final TransactionV1Payload payload = TransactionV1Payload.builder()
            ...
            .fields(Fields.builder()
                ...
                .target(new Native())
                .entryPoint(new WithdrawBidEntryPoint()).build()
            )
            .build();
